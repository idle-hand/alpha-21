# no_class_21 - ver-001 - Sunday july 15 2018
...
def hit():
    ...
    count = count + 1
    print ('Player >' + str(player_score))'''debugging will need to remove '''
    win_chek()
...
QuitBut = Button(Main_win, text="Quit", command=root.destroy)
QuitBut.grid(column=2, row=4)
